...
Public Class KFKMAIN010

    Private CAST As New CASTCommon.Events
    Private CASTx01 As New CASTCommon.Events("0-9", CASTCommon.Events.KeyMode.GOOD)

    Private MainLOG As New CASTCommon.BatchLOG("KFKMAIN010", "資金決済リエンタ作成画面")
    Private Const msgTitle As String = "資金決済リエンタ作成画面(KFKMAIN010)"
    ...
    Private Const ThisModuleName As String = "KFKMAIN010.vb"
...
#End Region
    ...
    '画面LOAD時
    Private Sub KFKMAIN010_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        ...
        Try
            ...
            If RIENTASV = BATCHSV Then  'ジョブ起動
                ...
                dRet = MessageBox.Show(MSG0023I.Replace("{0}", "資金決済リエンタ作成"), msgTitle, MessageBoxButtons.OKCancel, MessageBoxIcon.Question)

            Else                        'バッチ起動

                dRet = MessageBox.Show(MSG0015I.Replace("{0}", "資金決済リエンタ作成"), msgTitle, MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
            ...
            If RIENTASV = BATCHSV Then  'ジョブ起動
                ...
                MessageBox.Show(MSG0021I.Replace("{0}", "資金決済リエンタ作成"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information)
            ...
            Else                        'バッチ起動
                ...
                Dim SInfo As New ProcessStartInfo(Path.Combine(ExePath, "KFK010.EXE"), KESSAI_DATE)
                ...
                If l_exitcode <> 0 Then
                    ...
                    MessageBox.Show(MSG0034E.Replace("{0}", "資金決済リエンタ作成"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
                ...
                Else
                    ...
                    MessageBox.Show(MSG0016I.Replace("{0}", "資金決済リエンタ作成"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information)
