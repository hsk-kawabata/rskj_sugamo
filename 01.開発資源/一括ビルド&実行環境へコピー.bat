...
ECHO 実行ファイルを実行環境へ上書き中です．．．
COPY EXE\*.dll ..\02.実行環境\C\RSKJ\EXE\ /Y >> build.log
C:\WINDOWS\system32\XCOPY EXE\*.exe ..\02.実行環境\C\RSKJ\EXE\ /Y /EXCLUDE:list.txt >> build.log

DIR /S *.vb > ..\99.更新履歴\%DATE:/=%ソース更新履歴.txt
