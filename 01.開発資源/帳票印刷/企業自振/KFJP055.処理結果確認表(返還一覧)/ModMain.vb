...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFJP055", "処理結果確認表(返還一覧)")
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' 処理結果確認表(返還一覧)印刷処理
            '---------------------------------------------------------
            Dim henkan1ran As New KFJP055()
            henkan1ran.CreateCsvFile()
            If henkan1ran.MakeRecord = False Then
            ...
            '印刷処理実行
            If henkan1ran.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "RepoAgent印刷", "失敗", henkan1ran.ReportMessage)
