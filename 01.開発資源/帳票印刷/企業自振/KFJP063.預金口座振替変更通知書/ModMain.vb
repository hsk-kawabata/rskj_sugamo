'========================================================================
'ModMain
'預金口座振替変更通知書出力（KFJP063）　メインモジュール
'
'作成日：2017/03/09
'作成者：
'
...
#Region "クラス定数定義"
    Public BatchLog As New CASTCommon.BatchLOG("KFJP063", "預金口座振替変更通知書")

    '帳票名
    Public Const strPrintName As String = "預金口座振替変更通知書"
    'ログ出力用
    Public Const strLogWrite As String = "KFJP063（" & strPrintName & "）"
