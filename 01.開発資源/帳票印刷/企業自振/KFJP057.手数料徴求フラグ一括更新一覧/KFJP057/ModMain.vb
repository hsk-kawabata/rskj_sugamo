...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP057", "手数料徴求フラグ一括更新一覧")
    
    '
    ' 機能　 ：手数料徴求フラグ一括更新一覧印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' 手数料徴求フラグ一括更新一覧印刷処理
            '---------------------------------------------------------
            Dim PrintClass As New KFJP057(CSVFileName)

            '印刷処理実行
            If PrintClass.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LoginID, "0000000000-00", "00000000", "RepoAgent印刷", "失敗", PrintClass.ReportMessage)
