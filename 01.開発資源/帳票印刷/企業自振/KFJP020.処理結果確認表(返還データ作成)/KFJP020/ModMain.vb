...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP020", "処理結果確認表(返還データ作成)")

    '
    ' 機能　 ：処理結果確認表(返還データ作成)印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            End If
            '---------------------------------------------------------
            ' 処理結果確認表(返還データ作成)印刷処理
            '---------------------------------------------------------
            Dim FUNOU As New KFJP020(CSVFileName)
