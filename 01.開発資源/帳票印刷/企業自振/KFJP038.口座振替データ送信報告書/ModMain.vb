...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP038", "口座振替データ送信報告書")
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            BatchLog.Write("", LW.ToriCode, LW.FuriDate, "(印刷処理)開始", "成功", "")
            ...
            ' 口座振替データ送信報告書印刷処理
            '---------------------------------------------------------
            Dim Soufuhyo As New KFJP038(CSVFileName)

            '印刷処理実行
            If Soufuhyo.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "RepoAgent印刷", "失敗", Soufuhyo.ReportMessage)
