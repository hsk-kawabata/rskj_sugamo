...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP059", "KFJP059_取引先マスタメンテ(登録)")
    ...
    '
    ' 機能　 ：KFJP059_取引先マスタメンテ(登録)印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            End If
            '---------------------------------------------------------
            ' KFJP059_取引先マスタメンテ(登録) 印刷処理
            '---------------------------------------------------------
            Dim TORIMAST_MENTE As New KFJP059(CSVFileName)
