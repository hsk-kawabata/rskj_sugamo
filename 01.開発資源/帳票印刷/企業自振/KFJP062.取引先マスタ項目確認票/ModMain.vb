'========================================================================
'ModMain
'取引先マスタ項目確認票出力（KFJP062）　メインモジュール
'
'作成日：2017/03/06
'作成者：
'
...
#Region "クラス定数定義"
    Public BatchLog As New CASTCommon.BatchLOG("KFJP062", "取引先マスタ項目確認票")

    '帳票名
    Public Const strPrintName As String = "取引先マスタ項目確認票"
    'ログ出力用
    Public Const strLogWrite As String = "KFJP062（" & strPrintName & "）"
    'RSV2 MASTPTN
