...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFJP033", "スケジュール表")
    ...
    Public PrintNo As Integer        '印刷帳票(1:月間 2:振替日指定)
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' スケジュール表印刷処理
            '---------------------------------------------------------
            Dim SCH As New KFJP033(PrintNo)
            SCH.CreateCsvFile()
