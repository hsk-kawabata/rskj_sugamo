...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFJP054", "処理結果確認表(落込一覧)")
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' 処理結果確認表(落込一覧)印刷処理
            '---------------------------------------------------------
            Dim Otoshikomi1ran As New KFJP054()
            Otoshikomi1ran.CreateCsvFile()
            If Otoshikomi1ran.MakeRecord = False Then
            ...
            '印刷処理実行
            If Otoshikomi1ran.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "RepoAgent印刷", "失敗", Otoshikomi1ran.ReportMessage)
