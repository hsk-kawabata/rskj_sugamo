...
Public Class KFJP035

    Inherits CAstReports.ClsReportBase
    Sub New()
        ' CSVファイルセット
        InfoReport.ReportName = "KFJP035"

        ' 定義体名セット
        ReportBaseName = "KFJP035_取引先マスタ索引簿.rpd"
    End Sub
    ...
    Public Function MakeRecord() As Boolean
        ...
        Try
            ...
            Select Case SortCd
                ...
                Case "2" '振替/企業コード順
                    SQL.Append(" ORDER BY FURI_CODE_T,KIGYO_CODE_T")
                Case "3" '委託者カナ名順
                    SQL.Append(" ORDER BY ITAKU_KNAME_T")
            End Select
            ...
            If oraReader.DataReader(SQL) = True Then
                While oraReader.EOF = False
                    ...
                    For No As Integer = 1 To 31
                        ...
                        End If
                    Next
                    OutputCsvData(FURI_DATE, True, True)                                    '契約振替日
                    oraReader.NextRead()
                    RecordCnt += 1
                End While
            Else
