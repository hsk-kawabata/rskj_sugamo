...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP009", "センターカットデータ作成対象一覧")
    
    '
    ' 機能　 ：センターカットデータ作成対象一覧印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            End If
            '---------------------------------------------------------
            ' センターカットデータ作成対象一覧印刷処理
            '---------------------------------------------------------
            Dim TAISHO1RAN As New KFJP009(CSVFileName)
