...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP021", "処理結果確認表(再振データ作成)")

    '
    ' 機能　 ：処理結果確認表(再振データ作成)印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
           BatchLog.Write(LoginID, Toris_Code & "-" & Torif_Code, "00000000", "(印刷処理)開始", "成功", "")
            ...
            End If
            '---------------------------------------------------------
            ' 処理結果確認表(再振データ作成)印刷処理
            '---------------------------------------------------------
            Dim FUNOU As New KFJP021(CSVFileName)
