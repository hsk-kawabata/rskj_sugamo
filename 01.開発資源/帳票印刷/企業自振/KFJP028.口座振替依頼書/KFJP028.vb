...
Public Class KFJP028
    ...
    Sub New()
        ' CSVファイルセット
        InfoReport.ReportName = "KFJP028"

        ' 定義体名セット
        ReportBaseName = "KFJP028_口座振替依頼書.rpd"
    End Sub
    ...
    Public Function MakeRecord() As Boolean
        ...
        Try
            ...
            SQL.Append(" FROM TORIMAST,SCHMAST,TENMAST")
    ...
    Private Function SetENTMAST() As Boolean
        ...
        Try
            ...
            SQL.Append(" FROM ENTMAST,TORIMAST,TENMAST")
            ...
            If oraReader.DataReader(SQL) = True Then
                While oraReader.EOF = False
                    ...
                    OutputCsvData(GCOM.NzStr(oraReader.GetString("TKIN_NO_E")), True)               '引落金融機関コード
                    OutputCsvData(GCOM.NzStr(oraReader.GetString("KIN_NNAME_N")), True)             '引落金融機関名
                    OutputCsvData(GCOM.NzStr(oraReader.GetString("TSIT_NO_E")), True)               '引落支店コード
                    OutputCsvData(GCOM.NzStr(oraReader.GetString("SIT_NNAME_N")), True)             '引落支店名
                    ...
                    OutputCsvData(GCOM.NzStr(oraReader.GetString("FURIKIN_E")), True)               '振替金額
