...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP041", "口座チェック確認表(当日受付分)")
    
    '
    ' 機能　 ：口座チェック確認表(当日受付分)印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            End If
            '---------------------------------------------------------
            ' 口座チェック確認表(当日受付分)印刷処理
            '---------------------------------------------------------
            Dim PrnSch As New KFJP041(CSVFileName)
