...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFJP051", "地区伝送データ送信連絡票")
    
    '
    ' 機能　 ：KFJP051_地区伝送データ送信連絡票印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            '---------------------------------------------------------
            Dim clsChiku As New KFJP051(CSVFileName)

            '印刷処理実行
            If clsChiku.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LoginID, "0000000000-00", "00000000", "RepoAgent印刷", "失敗", clsChiku.ReportMessage)
