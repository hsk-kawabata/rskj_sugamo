...
#Region "クラス変数"
    ...
    Public MainLOG As New CASTCommon.BatchLOG("KFJP060", "再振対象先チェックリスト")
...
#Region "パブリックメソッド"
    ...
    Public Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            '再振対象先チェックリスト印刷処理
            '---------------------------------------------------------
            Dim List As New KFJP060
            List.PARA_SYS_DATE = Cmd(1)
            List.CreateCsvFile()
