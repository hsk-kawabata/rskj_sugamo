...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFJP053", "自振管理リスト")
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' 自振管理リスト印刷処理
            '---------------------------------------------------------
            Dim KanriList As New KFJP053()
            KanriList.CreateCsvFile()
            If KanriList.MakeRecord = False Then
            ...
            '印刷処理実行
            If KanriList.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "RepoAgent印刷", "失敗", KanriList.ReportMessage)
