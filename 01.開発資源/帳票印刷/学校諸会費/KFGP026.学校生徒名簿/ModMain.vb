...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFGP026", "学校生徒名簿")
    ...
    Public GAKUNEN As String         '学年コード
    Public TUKI As String               '月
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            GAKUNEN = Cmd(2)            '学年
            TUKI = Cmd(3)               '月
            PrintSort_Seito = Cmd(4)    '帳票ソート順1
            PrintSort_Tuuban = Cmd(5)   '2
            PrintSort_Waon = Cmd(6)     '3
            PrintSort_Seibetu = Cmd(7)  '4
            BatchLog.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "パラメータ取得", "成功", "コマンドライン引数：" & CmdArgs(0))
            '---------------------------------------------------------
            ' 学校生徒名簿印刷処理
            '---------------------------------------------------------
            Dim List As New KFGP026()
            List.CreateCsvFile()
