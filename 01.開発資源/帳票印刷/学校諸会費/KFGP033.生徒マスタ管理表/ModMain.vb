...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFGP033", "生徒マスタ管理表")
    ...
    Public SEITO_COUNT As String = 0        '生徒数
    Public Himoku_NAME(9) As String         '費目名
