...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFGP027", "生徒マスタ登録チェックリスト")
    ...
    Public KousinDate As String         '更新日
    Public Tuki As String               '対象月
    Public PrintSort As String          '印刷ソート順
    Public PrintKbn As String           '1:生徒マスタ 2:新入生マスタ
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            KousinDate = Cmd(2)         '更新日
            Tuki = Cmd(3)               '月
            PrintSort = Cmd(4)          '帳票ソート順
            PrintKbn = Cmd(5)           '印刷区分
            ...
            ' 生徒マスタ登録チェックリスト印刷処理
            '---------------------------------------------------------
            Dim List As New KFGP027(PrintKbn)
            List.CreateCsvFile()
