...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFGP013", "口座振替予定一覧表")
    ...
    Public PrintSort As String          '帳票ソート順
