...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFGP108", "生徒マスタメンテ（削除）")
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' 生徒マスタメンテ（削除）印刷処理
            '---------------------------------------------------------
            Dim List As New KFGP108(CSVFileName)

            '印刷処理実行
            If List.G_ReportExecute(PrinterName) Then
            Else
                '印刷失敗
