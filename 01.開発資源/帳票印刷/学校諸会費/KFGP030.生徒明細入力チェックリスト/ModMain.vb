...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFGP030", "生徒明細入力チェックリスト")
    ...
    Public FuriKbn As String            '振替区分(1:入金 2:出金)
