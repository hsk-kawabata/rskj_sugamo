...
#Region "クラス定数定義"
    Public BatchLog As New CASTCommon.BatchLOG("KFGP038", "学校マスタ項目確認票")

    '帳票名
    Public Const strPrintName As String = "学校マスタ項目確認票"
    'ログ出力用
    Public Const strLogWrite As String = "KFGP038（" & strPrintName & "）"
    'RSV2 MASTPTN
...
#Region "メインメソッド"
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            '印刷処理実行
            If clsRep.G_ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
