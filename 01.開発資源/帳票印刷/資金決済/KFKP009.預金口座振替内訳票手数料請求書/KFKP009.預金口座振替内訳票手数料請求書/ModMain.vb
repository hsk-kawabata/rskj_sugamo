...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFKP009", "預金口座振替票手数料請求書")
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' 預金口座振替票手数料請求書印刷処理
            '---------------------------------------------------------
            Dim clsPrnTESUU As New KFKP009()
            clsPrnTESUU.CreateCsvFile()
            If clsPrnTESUU.MakeRecord = False Then
            ...
            '印刷処理実行
            If clsPrnTESUU.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "RepoAgent印刷", "失敗", clsPrnTESUU.ReportMessage)
