...
' 手数料未徴求企業一覧表印刷 メインモジュール
Module ModMain

    Public BatchLog As New CASTCommon.BatchLOG("KFKP007", "手数料未徴求企業一覧表")
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            txtTESUU_YDATE = Param(1)        ' 手数料徴求予定日
