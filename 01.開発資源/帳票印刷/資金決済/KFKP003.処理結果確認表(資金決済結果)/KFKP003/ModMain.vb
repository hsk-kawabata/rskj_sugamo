...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFKP003", "処理結果確認表(資金決済結果)")

    '
    ' 機能　 ：処理結果確認表(資金決済結果)印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            If CmdArgs.Length = 0 Then
                'パラメータ取得失敗
                BatchLog.Write(LoginID, Toris_Code & "-" & Torif_Code, "00000000", "パラメータチェック", "失敗", "コマンドライン引数なし")
                Return -100
            End If
            ...
            ' 処理結果確認表(資金決済結果)印刷処理
            '---------------------------------------------------------
            Dim FUNOU As New KFKP003(CSVFileName, RpdPtn)
