...
Public Class KFSP025

    Inherits CAstReports.ClsReportBase
    Sub New()
        ' CSVファイルセット
        InfoReport.ReportName = "KFSP025"

        ' 定義体名セット
        ReportBaseName = "KFSP025_契約者一覧表.rpd"
    End Sub
    ...
    Public Function MakeRecord() As Boolean
        ...
        Try
            ...
            SQL.Append(" FROM S_TORIMAST,S_ENTMAST,TENMAST")
            ...
            If oraReader.DataReader(SQL) = True Then
                While oraReader.EOF = False
                    ...
                    OutputCsvData(GCOM.NzStr(oraReader.GetString("KEIYAKU_KNAME_E")), True, True)     '契約者名カナ
                    oraReader.NextRead()
                    RecordCnt += 1
                End While
            Else
