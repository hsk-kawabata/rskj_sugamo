...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFSP031", "KFSP031_取引先マスタメンテ(登録)")
    ...
    '
    ' 機能　 ：KFSP031_取引先マスタメンテ(登録)印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            End If
            '---------------------------------------------------------
            ' KFSP031_取引先マスタメンテ(登録) 印刷処理
            '---------------------------------------------------------
            Dim TORIMAST_MENTE As New KFSP031(CSVFileName)

            '印刷処理実行
            If TORIMAST_MENTE.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "RepoAgent印刷", "失敗", TORIMAST_MENTE.ReportMessage)
