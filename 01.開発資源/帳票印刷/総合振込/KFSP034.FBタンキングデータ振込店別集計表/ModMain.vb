...
#Region "モジュール変数"
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFSP034", "FBタンキングデータ振込店別集計表")
...
#Region "パブリックメソッド"
    ...
    Public Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            End If
            '---------------------------------------------------------
            ' FBタンキングデータ振込店別集計表印刷処理
            '---------------------------------------------------------
            Dim List As New KFSP034(CSVFileName)
