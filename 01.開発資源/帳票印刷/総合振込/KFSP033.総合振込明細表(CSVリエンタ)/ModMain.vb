...
#Region "モジュール変数"
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFSP033", "総合振込明細表(CSVリエンタ)")
...
#Region "パブリックメソッド"
    ...
    Public Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            End If
            '---------------------------------------------------------
            ' 総合振込明細表(CSVリエンタ)印刷処理
            '---------------------------------------------------------
            Dim List As New KFSP033(CSVFileName)
