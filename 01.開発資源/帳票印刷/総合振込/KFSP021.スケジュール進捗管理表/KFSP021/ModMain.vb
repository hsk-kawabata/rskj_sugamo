...
Module ModMain
    ...
    Private BatchLog As New CASTCommon.BatchLOG("KFSP021", "スケジュール進捗管理表")
    
    '
    ' 機能　 ：スケジュール進捗管理表印刷 メイン処理
    '
    ' 引数　 ：ARG1 - 起動パラメータ
    '
    ' 戻り値 ： 0    － 正常
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            ' スケジュール進捗管理表印刷処理
            '---------------------------------------------------------
            Dim PrnSch As New KFSP021(CSVFileName)

            '印刷処理実行
            If PrnSch.ReportExecute(PrinterName) = True Then
                '印刷成功
            Else
                '印刷失敗
                BatchLog.Write(LoginID, "0000000000-00", "00000000", "RepoAgent印刷", "失敗", PrnSch.ReportMessage)
        ...
        Finally
            BatchLog.Write(LoginID, "0000000000-00", "00000000", "終了", "(印刷処理)成功", "")
        End Try
