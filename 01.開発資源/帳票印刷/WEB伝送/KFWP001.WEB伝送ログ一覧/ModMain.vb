...
' WEB伝送ログ一覧表印刷 メインモジュール
Module ModMain

    Public BatchLog As New CASTCommon.BatchLOG("KFWP001", "WEB伝送ログ一覧")
