...
#Region "クラス変数"
    Public BatchLog As New CASTCommon.BatchLOG("KF3SP001", "SSS引落結果合計表")
...
#Region "パブリックメソッド"
    ...
    Public Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            ...
            TORI_CODE = Cmd(1)
            FURI_DATE = Cmd(2)
            TORIS_CODE = Cmd(1).Substring(0, 10)
            TORIF_CODE = Cmd(1).Substring(10, 2)
    ...
    Private Function GetIniInfo() As Boolean
        Try
            ...
            If IniInfo.ZEIKIJUN.Equals("err") OrElse IniInfo.ZEIKIJUN = Nothing Then
                BatchLog.Write("INIファイル取得", "失敗", "[COMMON].ZEIKIJUN 取得失敗")
                Return False
            End If
