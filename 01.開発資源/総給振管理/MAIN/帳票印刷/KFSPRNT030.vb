...
Public Class KFSPRNT030

    Private MainLOG As New CASTCommon.BatchLOG("KFSPRNT030", "スケジュール表印刷画面")
    Private Const msgTitle As String = "スケジュール表印刷画面(KFSPRNT030)"
...
#Region "ロード"
    Private Sub KFJPRNT030_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
            Dim Msg As String = ""
            Select Case GCom.SetComboBox(cmbPrintKbn, "KFSPRNT030_印刷区分.TXT", True)
                Case 1  'ファイルなし
                    MessageBox.Show(String.Format(MSG0025E, "持込区分", "KFSPRNT030_印刷区分.TXT"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Msg = "持込区分設定ファイルなし。ファイル:KFSPRNT030_印刷区分.TXT"
...
#Region "印刷"
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        ...
        Try
            ...
            'パラメータ設定：ログイン名,対象年月日,印刷帳票(1:月間スケジュール表 2:振込日指定スケジュール表),印刷区分
            If rdbDATE.Checked Then '振込日指定
            ...
            nRet = ExeRepo.ExecReport("KFSP027.EXE", param)
