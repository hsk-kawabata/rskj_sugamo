...
Public Class KFSPRNT010

#Region "変数宣言"
    Private MainLOG As New CASTCommon.BatchLOG("KFSPRNT010", "取引先マスタチェックリスト印刷画面")
    Private Const msgTitle As String = "取引先マスタチェックリスト印刷画面(KFSPRNT010)"
...
#Region "ロード"
    Private Sub KFSPRNT010_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'ログの書込に必要な情報の取得
...
#Region "印刷"
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        Try
            ...
            nRet = ExeRepo.ExecReport("KFSP026.EXE", param)
