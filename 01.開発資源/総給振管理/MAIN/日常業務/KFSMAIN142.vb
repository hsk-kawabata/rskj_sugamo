...
''' </summary>
''' <remarks></remarks>
Public Class KFSMAIN142

#Region "クラス定数"
    Private Const msgTitle As String = "入庫情報一覧画面(KFSMAIN142)"
    Private CAST As New CASTCommon.Events

#End Region

#Region "クラス変数"
    Private MainLOG As New CASTCommon.BatchLOG("KFSMAIN142", "入庫情報一覧画面")
...
#Region "イベントハンドラ"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub KFSMAIN142_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '--------------------------------------------------
            'ログの書込に必要な情報の取得
            '--------------------------------------------------
...
#Region "プライベートメソッド"
    ...
    Private Sub FormDataLoad()
        ...
        Try
            ...
            SQL.Append(" FROM S_TORIMAST_VIEW) G")
            ...
            If OraReader.DataReader(SQL) = True Then
                While OraReader.EOF = False
                    ...
                    LineData(9) = GCom.NzStr(OraReader.GetItem("FURI_DATE_ME"))             '振込日
