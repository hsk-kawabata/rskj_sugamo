...
#Region " 変数宣言"
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFSMAIN100", "振込発信データ作成（当日異例）画面")
    Private Const msgTitle As String = "振込発信データ作成（当日異例）画面(KFSMAIN100)"
    ...
    Private FURIKOMI_DATE As String              '振込日
...
#End Region
    ...
    '画面LOAD時
    Private Sub KFSMAIN100_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        ...
        Try
            ...
            'ジョブマスタに登録
            jobid = "S050"
            para = FURIKOMI_DATE & ",2"                 ' "振込日","2(当日異例)" をパラメタとして設定
            ...
            MessageBox.Show(MSG0021I.Replace("{0}", "振込発信データ作成(当日異例)"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnRef_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRef.Click
        ...
        Try
            ...
            FURIKOMI_DATE = txtKijyunDateY.Text & txtKijyunDateM.Text & txtKijyunDateD.Text

            '１／２営業日後
            GCom.CheckDateModule(FURIKOMI_DATE, EIGYOUBI_1_AFTER, 1, 0)
            GCom.CheckDateModule(FURIKOMI_DATE, EIGYOUBI_2_AFTER, 2, 0)
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            For Each item As ListViewItem In nItems
                CreateCSV.OutputCsvData(FURIKOMI_DATE)                                  '振込日
            ...
            'パラメータ変更　ログイン名、ＣＳＶファイル名、"5(当日異例)"
            param = GCom.GetUserID & "," & strCSVFileName & ",5"
...
#Region " 関数"
    ...
    Private Function HassinDataList() As Integer
        ...
        Try
            ...
            SQL.AppendLine(" AND FURI_DATE_S       = '" & FURIKOMI_DATE & "'")
