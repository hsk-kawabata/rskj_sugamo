...
Public Class KFSMAIN150

#Region "クラス定数"
    Private Const msgTitle As String = "一括照合画面(KFSMAIN150)"

#End Region

#Region "クラス変数"
    Private MainLOG As New CASTCommon.BatchLOG("KFSMAIN150", "一括照合画面")
...
#Region "イベントハンドラ"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub KFSMAIN150_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '--------------------------------------------------
            'ログの書込に必要な情報の取得
            '--------------------------------------------------
    ...
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        Try
            ...
            Dim para As String = "0,3"      '連携区分,振替処理区分(連携区分は無いので暫定で0を設定)
