...
Public Class KFSENTR070
    Private CAST As New CASTCommon.Events
    Private CASTx01 As New CASTCommon.Events("0-9", CASTCommon.Events.KeyMode.GOOD)

    Private strBAITAI_CODE As String

    Private MainLOG As New CASTCommon.BatchLOG("KFSENTR070", "振込口座一括削除画面")
    Private Const msgTitle As String = "振込口座一括削除画面(KFSENTR070)"
...
#Region " ロード"
    Private Sub KFSENTR070_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'ログの書込に必要な情報の取得
...
#Region " 更新"
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        ...
        Try
            ...
            Select Case strBAITAI_CODE
                Case "04"
                    SQL.Append("DELETE FROM S_ENTMAST")
                    SQL2.Append("DELETE FROM S_FUKU_ENTMAST")
                Case "09"
                    SQL.Append("DELETE FROM S_DENPYOMAST")
                    SQL2.Append("DELETE FROM S_FUKU_DENPYOMAST")
            End Select
