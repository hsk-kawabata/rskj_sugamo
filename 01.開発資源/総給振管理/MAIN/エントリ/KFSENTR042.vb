...
#Region " 変数"
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFSENTR042", "伝票用情報入力画面")
    Private Const msgTitle As String = "伝票用情報入力画面(KFSENTR042)"
...
#Region " ロード"
    Private Sub KFSENTR042_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'ログの書込に必要な情報の取得
