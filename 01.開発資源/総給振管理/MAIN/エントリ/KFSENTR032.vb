...
Public Class KFSENTR032
    Private CAST As New CASTCommon.Events
    Private CASTxx As New CASTCommon.Events("0-9a-zA-Z._-", CASTCommon.Events.KeyMode.GOOD)
    Private CASTx01 As New CASTCommon.Events("0-9", CASTCommon.Events.KeyMode.GOOD)

    Private MainLOG As New CASTCommon.BatchLOG("KFSENTR032", "依頼書用金額入力画面")
    Private Const msgTitle As String = "依頼書用金額入力画面(KFSENTR032)"
...
#Region " ロード"
    Private Sub KFSENTR032_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'ログの書込に必要な情報の取得
