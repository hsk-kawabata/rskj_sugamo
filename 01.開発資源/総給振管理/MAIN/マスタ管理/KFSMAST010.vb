...
Public Class KFSMAST010
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFSMAST010", "取引先マスタメンテナンス画面")
    Private Const msgTitle As String = "取引先マスタメンテナンス画面(KFSMAST010)"
    ...
    '2014/01/14 saitou 標準版 印紙税対応 ADD --------------------------------------------------<<<<
#Region " ロード"
    Private Sub KFSMAST010_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
