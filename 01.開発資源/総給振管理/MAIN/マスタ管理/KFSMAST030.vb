...
#Region "変数宣言"
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFSMAST030", "スケジュールメンテナンス画面")
    Private Const msgTitle As String = "スケジュールメンテナンス画面(KFSMAST030)"
...
#End Region
    ...
    '画面起動時イベント
    Private Sub KFSMAST0300G_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'ログの書込に必要な情報の取得
        ...
        Try
            ...
            Else
                ...
                If CLS.GetColumnValue("UKETUKE_FLG_S", 0) > 0 OrElse _
                   ...
                   CLS.GetColumnValue("TYUUDAN_FLG_S", 0) > 0 Then
