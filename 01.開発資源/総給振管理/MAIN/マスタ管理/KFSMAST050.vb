...
''' </summary>
''' <remarks></remarks>
Public Class KFSMAST050

#Region "クラス定数"
    Private Const msgTitle As String = "振込手数料マスタメンテナンス画面(KFSMAST050)"
...
#Region "クラス変数"
    Private MainLOG As New CASTCommon.BatchLOG("KFSMAST050", "振込手数料マスタメンテナンス画面")
...
#Region "イベントハンドラ"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub KFSMAST050_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '------------------------------------------------
            'ログの書込に必要な情報の取得
            '------------------------------------------------
            ...
            '手数料検索コンボボックスの設定
            '------------------------------------------------
            If GCom.SelectTesuuName(Me.cmbTesuuName, Me.txtTaxID, Me.txtTesuuID, "3") = -1 Then
            ...
            Else
                ...
                Me.Label28.Text = strInshizei1 & "円未満"
                Me.Label12.Text = strInshizei1 & "円以上" & strInshizei2 & "円未満"
                Me.Label13.Text = strInshizei2 & "円以上"
                Me.Label40.Text = strInshizei1 & "円未満"
                Me.Label29.Text = strInshizei1 & "円以上" & strInshizei2 & "円未満"
                Me.Label30.Text = strInshizei2 & "円以上"
            End If
            '2014/01/15 saitou 標準版 印紙税対応 ADD --------------------------------------------------<<<<
            ...
            For i As Integer = 0 To 2
                With SQL
                    ...
                    Select Case i
                        ...
                        Case 1
                            .Append(",'11'")
                            .Append("," & Me.DeleteComma(Me.txtTesuuA1S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuA2S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuA3S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuB1S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuB2S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuB3S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuC1S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuC2S.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuC3S.Text))
                        Case 2
                            .Append(",'12'")
                            .Append("," & Me.DeleteComma(Me.txtTesuuA1K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuA2K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuA3K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuB1K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuB2K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuB3K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuC1K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuC2K.Text))
                            .Append("," & Me.DeleteComma(Me.txtTesuuC3K.Text))
                    End Select
            ...
            For i As Integer = 0 To 2
                With SQL
                    ...
                    Select Case i
                        ...
                        Case 1
                            .Append(",TESUU_A1_C = " & Me.DeleteComma(Me.txtTesuuA1S.Text))
                            .Append(",TESUU_A2_C = " & Me.DeleteComma(Me.txtTesuuA2S.Text))
                            .Append(",TESUU_A3_C = " & Me.DeleteComma(Me.txtTesuuA3S.Text))
                            .Append(",TESUU_B1_C = " & Me.DeleteComma(Me.txtTesuuB1S.Text))
                            .Append(",TESUU_B2_C = " & Me.DeleteComma(Me.txtTesuuB2S.Text))
                            .Append(",TESUU_B3_C = " & Me.DeleteComma(Me.txtTesuuB3S.Text))
                            .Append(",TESUU_C1_C = " & Me.DeleteComma(Me.txtTesuuC1S.Text))
                            .Append(",TESUU_C2_C = " & Me.DeleteComma(Me.txtTesuuC2S.Text))
                            .Append(",TESUU_C3_C = " & Me.DeleteComma(Me.txtTesuuC3S.Text))
                            .Append(" where FSYORI_KBN_C = '3'")
                            .Append(" and SYUBETU_C = '11'")

                        Case 2
                            .Append(",TESUU_A1_C = " & Me.DeleteComma(Me.txtTesuuA1K.Text))
                            .Append(",TESUU_A2_C = " & Me.DeleteComma(Me.txtTesuuA2K.Text))
                            .Append(",TESUU_A3_C = " & Me.DeleteComma(Me.txtTesuuA3K.Text))
                            .Append(",TESUU_B1_C = " & Me.DeleteComma(Me.txtTesuuB1K.Text))
                            .Append(",TESUU_B2_C = " & Me.DeleteComma(Me.txtTesuuB2K.Text))
                            .Append(",TESUU_B3_C = " & Me.DeleteComma(Me.txtTesuuB3K.Text))
                            .Append(",TESUU_C1_C = " & Me.DeleteComma(Me.txtTesuuC1K.Text))
                            .Append(",TESUU_C2_C = " & Me.DeleteComma(Me.txtTesuuC2K.Text))
                            .Append(",TESUU_C3_C = " & Me.DeleteComma(Me.txtTesuuC3K.Text))
                            .Append(" where FSYORI_KBN_C = '3'")
            ...
            If oraReader.DataReader(CreateGetTesuumastSQL(Me.txtTesuuID.Text.Trim, Me.txtTaxID.Text.Trim)) = True Then
                ...
                While oraReader.EOF = False
                    ...
                    Select Case oraReader.GetString("SYUBETU_C")
                        ...
                        Case "11"
                            Me.txtTesuuA1S.Text = Me.AddComma(oraReader.GetString("TESUU_A1_C"))
                            Me.txtTesuuA2S.Text = Me.AddComma(oraReader.GetString("TESUU_A2_C"))
                            Me.txtTesuuA3S.Text = Me.AddComma(oraReader.GetString("TESUU_A3_C"))
                            Me.txtTesuuB1S.Text = Me.AddComma(oraReader.GetString("TESUU_B1_C"))
                            Me.txtTesuuB2S.Text = Me.AddComma(oraReader.GetString("TESUU_B2_C"))
                            Me.txtTesuuB3S.Text = Me.AddComma(oraReader.GetString("TESUU_B3_C"))
                            Me.txtTesuuC1S.Text = Me.AddComma(oraReader.GetString("TESUU_C1_C"))
                            Me.txtTesuuC2S.Text = Me.AddComma(oraReader.GetString("TESUU_C2_C"))
                            Me.txtTesuuC3S.Text = Me.AddComma(oraReader.GetString("TESUU_C3_C"))

                        Case "12"
                            Me.txtTesuuA1K.Text = Me.AddComma(oraReader.GetString("TESUU_A1_C"))
                            Me.txtTesuuA2K.Text = Me.AddComma(oraReader.GetString("TESUU_A2_C"))
                            Me.txtTesuuA3K.Text = Me.AddComma(oraReader.GetString("TESUU_A3_C"))
                            Me.txtTesuuB1K.Text = Me.AddComma(oraReader.GetString("TESUU_B1_C"))
                            Me.txtTesuuB2K.Text = Me.AddComma(oraReader.GetString("TESUU_B2_C"))
                            Me.txtTesuuB3K.Text = Me.AddComma(oraReader.GetString("TESUU_B3_C"))
                            Me.txtTesuuC1K.Text = Me.AddComma(oraReader.GetString("TESUU_C1_C"))
                            Me.txtTesuuC2K.Text = Me.AddComma(oraReader.GetString("TESUU_C2_C"))
                            Me.txtTesuuC3K.Text = Me.AddComma(oraReader.GetString("TESUU_C3_C"))
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            With SQL
                ...
                .Append(" and FSYORI_KBN_C = '3'")          '総振の振込手数料が設定されているか
            End With
            ...
            Dim param As String = GCom.GetUserID & "," & "3" & "," & Me.strSysDate
            'Dim param As String = GCom.GetUserID & "," & "3"
            '2014/01/15 saitou 標準版 印紙税対応 UPD --------------------------------------------------<<<<
    ...
    Private Sub Money_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) _
        ...
        txtTesuuC1F.Validating, txtTesuuC2F.Validating, txtTesuuC3F.Validating, _
        txtTesuuA1S.Validating, txtTesuuA2S.Validating, txtTesuuA3S.Validating, _
        txtTesuuB1S.Validating, txtTesuuB2S.Validating, txtTesuuB3S.Validating, _
        txtTesuuC1S.Validating, txtTesuuC2S.Validating, txtTesuuC3S.Validating, _
        txtTesuuA1K.Validating, txtTesuuA2K.Validating, txtTesuuA3K.Validating, _
        txtTesuuB1K.Validating, txtTesuuB2K.Validating, txtTesuuB3K.Validating, _
        txtTesuuC1K.Validating, txtTesuuC2K.Validating, txtTesuuC3K.Validating
        Try
...
#Region "プライベートメソッド"
    ...
    Private Function CheckText() As Boolean
        Try
            ...
            '先振手数料A1チェック
            If Me.txtTesuuA1S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuA1S.Focus()
                Return False
            End If

            '先振手数料A2チェック
            If Me.txtTesuuA2S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuA2S.Focus()
                Return False
            End If

            '先振手数料A3チェック
            If Me.txtTesuuA3S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuA3S.Focus()
                Return False
            End If

            '先振手数料B1チェック
            If Me.txtTesuuB1S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuB1S.Focus()
                Return False
            End If

            '先振手数料B2チェック
            If Me.txtTesuuB2S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuB2S.Focus()
                Return False
            End If

            '先振手数料B3チェック
            If Me.txtTesuuB3S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuB3S.Focus()
                Return False
            End If

            '先振手数料C1チェック
            If Me.txtTesuuC1S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuC1S.Focus()
                Return False
            End If

            '先振手数料C2チェック
            If Me.txtTesuuC2S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuC2S.Focus()
                Return False
            End If

            '先振手数料C3チェック
            If Me.txtTesuuC3S.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "先振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuC3S.Focus()
                Return False
            End If

            '給振手数料A1チェック
            If Me.txtTesuuA1K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuA1K.Focus()
                Return False
            End If

            '給振手数料A2チェック
            If Me.txtTesuuA2K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuA2K.Focus()
                Return False
            End If

            '給振手数料A3チェック
            If Me.txtTesuuA3K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuA3K.Focus()
                Return False
            End If

            '給振手数料B1チェック
            If Me.txtTesuuB1K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuB1K.Focus()
                Return False
            End If

            '給振手数料B2チェック
            If Me.txtTesuuB2K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuB2K.Focus()
                Return False
            End If

            '給振手数料B3チェック
            If Me.txtTesuuB3K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuB3K.Focus()
                Return False
            End If

            '給振手数料C1チェック
            If Me.txtTesuuC1K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuC1K.Focus()
                Return False
            End If

            '給振手数料C2チェック
            If Me.txtTesuuC2K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuC2K.Focus()
                Return False
            End If

            '給振手数料C3チェック
            If Me.txtTesuuC3K.Text.Trim = String.Empty Then
                MessageBox.Show(String.Format(MSG0285W, "給振手数料"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.txtTesuuC3K.Focus()
                Return False
            End If
