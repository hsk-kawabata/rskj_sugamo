...
'資金決済データ作成処理（金バッチ）
Public Class ClsKessaiDataCreateKinBatch

    Public MainLOG As New CASTCommon.BatchLOG("KFK030", "資金決済データ作成")
    ...
    Public Function Main(ByVal command As String) As Integer
        ...
        Try
            ...
            If dblock.Job_Lock(MainDB, LockWaitTime) = False Then
                MainLOG.Write_Err("(主処理)", "失敗", "資金決済データ作成処理で実行待ちタイムアウト")
                MainLOG.UpdateJOBMASTbyErr("資金決済データ作成処理で実行待ちタイムアウト")
                Return -1
            End If
            '*** End Add 2015/12/01 SO)荒木 for 多重実行対応 ***
            ...
            Else
                ...
                If iRet = 1 Then
                    jobMessage = "対象データ０件"
                Else
                    jobMessage = "データ作成件数:" & CntDenbun & "件"
                End If
    ...
    ' 備考　 ： 
    '
    Private Function fn_KessaiData(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Boolean
        ...
        Try
            ...
            With KData
                ...
                .ItakuCode = Key.ITAKU_CODE                             '委託者コード
                .Syubetu = Key.SYUBETU_CODE                             '種別コード
                .BaitaiCode = Key.BAITAI_CODE                           '媒体コード
                '2017/03/16 タスク）西野 ADD 標準版修正（資金決済性能改善）------------------------------------ START
    ...
    ' 備考　 ： 
    '
    Private Function fn_BETUDAN_OUT(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Integer
    ...
    ' 備考　 ： 
    '
    Private Function fn_TOUZA_IN(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Integer
    ...
    ' 備考　 ： 
    '
    Private Function fn_FUTUU_IN(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Integer
    ...
    ' 備考　 ： 
    '
    Private Function fn_BETUDAN_IN(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Integer
    ...
    ' 備考　 ： 
    '
    Private Function fn_SYOKANJO_IN(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Integer
    ...
    ' 備考　 ： 
    '
    Private Function fn_KAWASE_FURIKOMI(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Integer
        ...
        Try
            ...
            ' 資金決済データにオペコード毎の個別データを設定
            KData.record320 = KawaseFurikomiInFmt.DataKinBatch
    ...
    ' 備考　 ： 
    '
    Private Function fn_KAWASE_TUKEKAE(ByVal Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Integer
        ...
        Try
            ...
            ' 資金決済データにオペコード毎の個別データを設定
            KData.record320 = KawaseTukekaeInFmt.DataKinBatch
    ...
    ' 備考　 ： 
    '
    Private Function fn_TESUUIN_RENDO(ByRef key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch, ByVal TesuuMode As Integer) As Integer
    ...
    '
    '
    Private Function fn_TESUUIN_SYOKANJOIN(ByRef Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch, ByVal TesuuMode As Integer) As Integer
    ...
    ' 備考
    '
    Private Function fn_TESUUIN_SYOKANJORENDO(ByRef Key As KeyInfo, ByRef KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch, ByVal TesuuMode As Integer) As Integer
    ...
    ' 備考　 ： 
    '
    Private Function InsertKesMast(ByVal KData As CAstFormKes.ClsFormKes.KessaiDataKinBatch) As Boolean
        Dim SQL As New StringBuilder(128)

        Try
            MainLOG.Write("(資金決済連携データテーブル登録)開始", "成功")

            With SQL
                .Append("INSERT INTO K_I_RENKEIMAST (")
                .Append(" FSYORI_KBN_KR")
                .Append(",TORIS_CODE_KR")
                .Append(",TORIF_CODE_KR")
                .Append(",REC_RENKEI_KBN_KR")
                .Append(",SYORI_STS_KR")
                .Append(",SAKUSEI_DATE_KR")
                .Append(",SAKUSEI_TIME_KR")
                .Append(",KAIJI_KR")
                .Append(",RECORD_KR")
                .Append(",FURI_DATE_KR")
                .Append(",REN_TORIKOMI_DATE_KR")
                .Append(",REN_KEKKA_DATE_KR")
                .Append(",KKESAI_DATE_KR")
                .Append(",FURI_CODE_KR")
                .Append(",KIGYO_CODE_KR")
                .Append(",ITAKU_CODE_KR")
                .Append(",ITAKU_KNAME_KR")
                .Append(",ITAKU_NNAME_KR")
                .Append(",TORISIT_NO_KR")
                .Append(",SYUBETU_KR")
                .Append(",BAITAI_KR")
                .Append(",KESSAI_KBN_KR")
                .Append(",TESUUTYO_PATN_KR")
                .Append(",TESUUTYO_KBN_KR")
                .Append(",KAMOKU_KR")
                .Append(",OPE_KR")
                .Append(",TORIMATOME_SIT_KR")
                .Append(",SYORI_DATE_KR")
                .Append(",SYORI_TIME_KR")
                .Append(",KAWASE_NO_KR")
                .Append(",ERR_MESSAGE_CODE_KR")
                .Append(",ERR_MESSAGE_KR")
                .Append(",HASSIN_DENBUN_KR")
                .Append(",RIENTA_FD_KR")
                .Append(",YOBI1_KR")
                .Append(",YOBI2_KR")
                .Append(",YOBI3_KR")
                ...
                .Append(") VALUES (")
                .Append(" " & SQ("1"))                                      ' 振替処理区分
                .Append("," & SQ(KData.TorisCode))                          ' 取引先主コード
                .Append("," & SQ(KData.TorifCode))                          ' 取引先副コード
                .Append("," & SQ("1"))                                      ' レコード連携区分
                .Append("," & "0")                                          ' 処理状況(0:未抽出)
                .Append("," & SQ(strDate))                                  ' 作成日
                .Append("," & SQ(strTime))                                  ' 作成時刻
                .Append("," & SQ(keskey.Kaiji.ToString.PadLeft(2, "0"c)))   ' 作成回次
                .Append("," & keskey.RecordNo)                              ' レコード連番
                .Append("," & SQ(KData.FuriDate))                           ' 振替指定日
                .Append("," & SQ("00000000000000"))                         ' 連携取込日
                .Append("," & SQ("00000000000000"))                         ' 連携結果更新日
                .Append("," & SQ(KData.KessaiDate))                         ' 資金決済日
                .Append("," & SQ(KData.FuriCode))                           ' 振替コード
                .Append("," & SQ(KData.KigyoCode))                          ' 企業コード
                .Append("," & SQ(KData.ItakuCode))                          ' 委託者コード
                .Append("," & SQ(KData.ToriKName))                          ' 委託者名カナ
                .Append("," & SQ(KData.ToriNName))                          ' 委託者名漢字
                .Append("," & SQ(KData.TorimatomeSit))                      ' とりまとめ店
                .Append("," & SQ(KData.Syubetu))                            ' 種別コード
                .Append("," & SQ(KData.BaitaiCode))                         ' 媒体コード
                .Append("," & SQ(KData.KessaiKbn))                          ' 決済区分
                .Append("," & KData.TesTyohh)                               ' 手数料徴求方法
                .Append("," & KData.TesTyoKbn)                              ' 手数料徴求区分
                .Append("," & SQ(KData.OpeCode.Substring(0, 2)))            ' 科目コード
                .Append("," & SQ(KData.OpeCode.Substring(2, 3)))            ' オペコード
                .Append("," & SQ(ini_info.HONBU_CODE))                      ' 取扱店舗コード
                .Append("," & SQ("00000000"))                               ' 処理日(金バッチ)
                .Append("," & SQ("000000"))                                 ' 処理時間(金バッチ)
                .Append("," & SQ(""))                                       ' 為替通番
                .Append("," & SQ(""))                                       ' エラーメッセージコード
                .Append("," & SQ(""))                                       ' エラーメッセージ
                .Append("," & SQ(KData.record320))                          ' 発信電文情報
            ...
            CntDenbun += 1
        Catch ex As Exception
            MainLOG.Write("(資金決済連携データテーブル登録)", "失敗", ex.Message)
            Return False
        Finally
            MainLOG.Write("(資金決済連携データテーブル登録)開始", "成功")
        End Try
    ...
    Private Function MakeRientaFD(ByVal ary As ArrayList) As Boolean
        ...
        Dim Kdata As CAstFormKes.ClsFormKes.KessaiDataKinBatch
    ...
    Private Function GetKaiji() As Boolean
        ...
        Try
            ...
            sql.Append("SELECT NVL(MAX(KAIJI_KR),0) AS MAX_KAIJI FROM K_I_RENKEIMAST")
            ' 2017/11/10 タスク）西野 CHG (標準版不具合対応(№169)) -------------------- START
            sql.Append(" WHERE SAKUSEI_DATE_KR = " & SQ(strDate))
            'sql.Append(" WHERE SYORI_DATE_KR = " & SQ(strDate))
            ' 2017/11/10 タスク）西野 CHG (標準版不具合対応(№169)) -------------------- END
