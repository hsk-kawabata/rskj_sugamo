...
Module ModMain
    ...
    Public BatchLog As New CASTCommon.BatchLOG("KFJ011", "センター直接持込落込処理")
    Public Const msgTitle As String = "センター直接持込落込処理(KFJ011)"
    ...
    Function Main(ByVal CmdArgs() As String) As Integer
        ...
        Try
            '*** Str Add 2015/12/26 sys)mori for LOG強化対応 ***
            sw = BatchLog.Write_Enter1("", "0000000000-00", "00000000", "センタ直持処理(開始)", "成功")
        ...
        Finally
            '*** Str Add 2015/12/26 sys)mori for LOG強化対応 ***
            BatchLog.Write_Exit1(sw, "", "0000000000-00", "00000000", "センタ直持処理(終了)", "成功")
