...
Public Class KFJENTR032
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFJENTR032", "依頼書用金額入力画面")
    Private Const msgTitle As String = "依頼書用金額入力画面(KFJENTR032)"
    ...
    Private strJIKINKO_NO As String
    ...
    '画面表示項目用配列
    Public strTKIN_NO(700, 19) As String
    Public strTSIT_NO(700, 19) As String
    Public strTKIN_NAME(700, 19) As String
    Public strTSIT_NAME(700, 19) As String
    Public lngKOUBAN(700, 19) As Long
    Public strKAMOKU(700, 19) As String
    Public strKOUZA(700, 19) As String
    Public strKEIYAKU_NNAME(700, 19) As String
    Public strKEIYAKU_KNAME(700, 19) As String
    Public strKEIYAKU_NO(700, 19) As String
    Public lngFURIKIN(700, 19) As Long
    Public lngTESUU(700, 19) As Long
    Public strFURIDATE(700, 19) As String
    Public strKAIYAKU(700, 19) As String
    Public strKINGAKU_KBN(700, 19) As String
    Public lngHYOUJI_SEQ(700, 19) As Long  'update時のキー用
    Public strCHK_KEKKA(700, 19) As String '口座チェックの結果格納用
    'Public lngKOTEIKIN(700, 14) As Long '蒲郡信金向け　固定金額格納用
    ...
    'コントロール配列
    Private lblKOUBAN(19) As Label
    Private lblTKIN_NAME(19) As Label
    Private lblTSIT_NAME(19) As Label
    Private lblKAMOKU(19) As Label
    Private lblKOUZA(19) As Label
    Private lblKEIYAKU_NNAME(19) As Label
    Private lblKEIYAKU_NO(19) As Label
    Private txtFURIKIN(19) As TextBox
    Private lblTESUU(19) As Label
    ...
    Private KINKOCD As String           '自金庫コード
    Private KOUZACHK As String          '口座チェック
...
#Region " ロード"
    Private Sub KFJENTR032_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '#####################################
        'ログの書込に必要な情報の取得
...
#Region " 登録"
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        Try
            ...
            lngSYOUKEI2 = 0 '解約数または振替金額0円のものを引いた小計件数
            ...
            For lngPAGE_LOOP = LBound(strCHK_KEKKA, 1) To UBound(strCHK_KEKKA, 1)
                ...
                For lngGYO_LOOP = LBound(strCHK_KEKKA, 2) To UBound(strCHK_KEKKA, 2)
                    If strTSIT_NO(lngPAGE_LOOP, lngGYO_LOOP) = "" Then
                        Exit For
                    End If
                    If KINKOCD = strTKIN_NO(lngPAGE_LOOP, lngGYO_LOOP) Then   '自金庫のみ口座チェック
        ...
        Try
            ...
            If OraReader.DataReader(SQL) = True Then
                Do
                    ...
                    If lngGyo_CNT >= 20 Then '20行超えたら次ページ
                        lngGyo_CNT = 0
                    ...
                    lngKOUBAN(lngPage_CNT, lngGyo_CNT) = lngPage_CNT * 20 + lngGyo_CNT + 1 '項番取得
            ...
            If Int((lngMAX_Record - 1)) / 20 + 1 < lngPAGE Then        '開始頁ﾁｪｯｸ
                lngPAGE = Int((lngMAX_Record - 1)) / 20 + 1
            End If
...
start:
    ...
    Function fn_HYOUJI_GOUKEI() As Boolean
        ...
        Catch ex As Exception
            MessageBox.Show(MSG0006E, msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
            MainLOG.Write(LW.UserID, LW.ToriCode, LW.FuriDate, "(振替金額表示処理)", "失敗", ex.ToString)
            Return False
        End Try
    End Function
    ...
    Function fn_set_Control() As Boolean
        ...
        Try
            ...
            lblKOUBAN(15) = lblIndex16
            lblKOUBAN(16) = lblIndex17
            lblKOUBAN(17) = lblIndex18
            lblKOUBAN(18) = lblIndex19
            lblKOUBAN(19) = lblIndex20
            ...
            lblTKIN_NAME(15) = lblKinNName16
            lblTKIN_NAME(16) = lblKinNName17
            lblTKIN_NAME(17) = lblKinNName18
            lblTKIN_NAME(18) = lblKinNName19
            lblTKIN_NAME(19) = lblKinNName20
            ...
            lblTSIT_NAME(15) = lblSitNName16
            lblTSIT_NAME(16) = lblSitNName17
            lblTSIT_NAME(17) = lblSitNName18
            lblTSIT_NAME(18) = lblSitNName19
            lblTSIT_NAME(19) = lblSitNName20
            ...
            lblKAMOKU(15) = lblKamoku16
            lblKAMOKU(16) = lblKamoku17
            lblKAMOKU(17) = lblKamoku18
            lblKAMOKU(18) = lblKamoku19
            lblKAMOKU(19) = lblKamoku20
            ...
            lblKOUZA(15) = lblKouza16
            lblKOUZA(16) = lblKouza17
            lblKOUZA(17) = lblKouza18
            lblKOUZA(18) = lblKouza19
            lblKOUZA(19) = lblKouza20
            ...
            lblKEIYAKU_NNAME(15) = lblKeiyakuNM16
            lblKEIYAKU_NNAME(16) = lblKeiyakuNM17
            lblKEIYAKU_NNAME(17) = lblKeiyakuNM18
            lblKEIYAKU_NNAME(18) = lblKeiyakuNM19
            lblKEIYAKU_NNAME(19) = lblKeiyakuNM20
            ...
            lblKEIYAKU_NO(15) = lblKeiyakuNo16
            lblKEIYAKU_NO(16) = lblKeiyakuNo17
            lblKEIYAKU_NO(17) = lblKeiyakuNo18
            lblKEIYAKU_NO(18) = lblKeiyakuNo19
            lblKEIYAKU_NO(19) = lblKeiyakuNo20
            ...
            txtFURIKIN(15) = txtFuriKin16
            txtFURIKIN(16) = txtFuriKin17
            txtFURIKIN(17) = txtFuriKin18
            txtFURIKIN(18) = txtFuriKin19
            txtFURIKIN(19) = txtFuriKin20
            ...
            lblTESUU(15) = lblTesuuKin16
            lblTESUU(16) = lblTesuuKin17
            lblTESUU(17) = lblTesuuKin18
            lblTESUU(18) = lblTesuuKin19
            lblTESUU(19) = lblTesuuKin20
        Catch ex As Exception
            MessageBox.Show(MSG0006E, msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Function fn_ENTMAST_WRITE(ByVal alngPage As Long) As Integer
        ...
        Try
            ...
            lngLOOP_CNT = (alngPage * 20) + lngSYOUKEI
            lngPage_CNT = 0
            lngGyo_CNT = 0
            For lngPage_CNT = 0 To lngMAX_Page - 1
                ...
                For lngGyo_CNT = 0 To L_END
                    ...
                    SQL.Append(" FURI_DATE_E = " & SQ(strFURI_DATE)) '振替日
                    SQL.Append(",FURIKIN_E = " & lngFURIKIN(lngPage_CNT, lngGyo_CNT)) '振替金額
    ...
    Function fn_update_SCHMAST(ByRef UKETUKE As String) As Boolean
        ...
        Try
            ...
            ElseIf GCom.NzLong(fn_DEL_KANMA(txtGoukeiKin.Text)) > 0 AndAlso BERYFAI = "0" AndAlso intCHK = 0 Then
                '振替金額0以上かつベリファイ無しの場合は受付フラグを1にする
            ...
            ElseIf GCom.NzLong(fn_DEL_KANMA(txtGoukeiKin.Text)) > 0 AndAlso BERYFAI = "1" AndAlso intCHK = 1 Then
                '振替金額0以上かつ副の場合は受付フラグを1にする
                SQL.Append(",UKETUKE_FLG_S = '1'")      '受付済
                UKETUKE = "1"
            ElseIf GCom.NzLong(fn_DEL_KANMA(txtGoukeiKin.Text)) = 0 AndAlso BERYFAI = "1" AndAlso intCHK = 1 Then
                '振替金額0円の場合かつ副の場合は受付フラグを2にする
                SQL.Append(",UKETUKE_FLG_S = '2'")      'ベリファイ待ち
                UKETUKE = "3"
            Else
                '振替金額0以上かつベリファイありかつ主の場合は受付フラグを2にする
                SQL.Append(",UKETUKE_FLG_S = '2'")      'ベリファイ待ち
                UKETUKE = "2"
            End If
    ...
    Function fn_set_INIFILE() As Boolean
        ...
        Try
            ...
            If KINKOCD.ToUpper = "ERR" OrElse KINKOCD = Nothing Then
    ...
    Function fn_BERYFAI(ByVal aobjFURIKIN As TextBox, ByVal aobjlblKeiyakuNo As Label) As Boolean
        ...
        Try
            ...
            '依頼書マスタに登録されているか検索
            '-------------------------------------------
            SQL.Append("SELECT * FROM ENTMAST")
            SQL.Append(" WHERE TORIS_CODE_E = " & SQ(strTORIS_CODE))
            SQL.Append(" AND TORIF_CODE_E = " & SQ(strTORIF_CODE))
...
#Region " イベント"
    ...
    Private Sub txtFuriKin_Validating(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFuriKin1.Validating, txtFuriKin2.Validating, _
        ...
        txtFuriKin10.Validating, txtFuriKin11.Validating, txtFuriKin12.Validating, txtFuriKin13.Validating, txtFuriKin14.Validating, txtFuriKin15.Validating, _
        ...
        Try
            ...
            If KOUZACHK.ToUpper = "YES" Then
                If strTSIT_NO(lngPAGE - 1, strINDEX - 1) <> "" Then
                    If KINKOCD = strTKIN_NO(lngPAGE - 1, strINDEX - 1) Then   '自金庫のみ口座チェック
