...
Public Class KFJENTR031
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFJENTR031", "依頼書用金額入力画面")
    Private Const msgTitle As String = "依頼書用金額入力画面(KFJENTR031)"
...
#Region " ロード"
    Private Sub KFJENTR031_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '#####################################
        'ログの書込に必要な情報の取得
