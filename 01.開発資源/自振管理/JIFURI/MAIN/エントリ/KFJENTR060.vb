...
Public Class KFJENTR060
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFJENTR060", "契約者一覧表印刷画面")
    Private Const msgTitle As String = "契約者一覧表印刷画面(KFJENTR060)"
    ...
    Private Const ThisModuleName As String = "KFJENTR060.vb"
#Region " ロード"
    Private Sub KFJENTR060_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '#####################################
            'ログの書込に必要な情報の取得
...
#Region " 印刷"
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        Try
            ...
            nRet = ExeRepo.ExecReport("KFJP031.EXE", param)
