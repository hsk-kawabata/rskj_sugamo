...
Imports System.IO
Imports CASTCommon
Public Class KFJPRNT040
    Private MainLOG As New CASTCommon.BatchLOG("KFJPRNT040", "取引先マスタ索引簿印刷画面")
    Private Const msgTitle As String = "取引先マスタ索引簿印刷画面(KFJPRNT040)"
...
#Region " ロード"
    Private Sub KFJPRNT040_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '#####################################
        'ログの書込に必要な情報の取得
...
#Region " 印刷"
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        ...
        Try
            ...
            ElseIf rdbFuriKigyo.Checked Then
                param = GCom.GetUserID & ",2"
            Else
                param = GCom.GetUserID & ",3"
            End If

            nRet = ExeRepo.ExecReport("KFJP035.EXE", param)
