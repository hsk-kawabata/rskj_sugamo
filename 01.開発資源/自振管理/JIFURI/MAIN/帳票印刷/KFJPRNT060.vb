...
Imports System.IO
Imports CASTCommon
Public Class KFJPRNT060
    Private MainLOG As New CASTCommon.BatchLOG("KFJPRNT060", "振替結果変更チェックリスト印刷画面")
    Private Const msgTitle As String = "振替結果変更チェックリスト印刷画面(KFJPRNT060)"
...
#Region " 印刷"
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        ...
        Try
            ...
            '印刷前確認メッセージ
            If MessageBox.Show(String.Format(MSG0013I, "振替結果変更チェックリスト"), _
            ...
            nRet = ExeRepo.ExecReport("KFJP036.EXE", param)

            '戻り値に対応したメッセージを表示する
            Select Case nRet
                Case 0
                    '印刷後確認メッセージ
                    MessageBox.Show(String.Format(MSG0014I, "振替結果変更チェックリスト"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Case -1
                    '印刷対象なしメッセージ
                    MessageBox.Show(MSG0106W, msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Case Else
                    '印刷失敗メッセージ
                    MessageBox.Show(String.Format(MSG0004E, "振替結果変更チェックリスト"), msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Select
...
#Region " 関数"
    ...
    Private Function fn_check_Table() As Boolean
        ...
        Try
            ...
            SQL.Append(" FROM MEIMAST,KEKKA_RIREKIMAST,TORIMAST")
            ...
            SQL.Append(" AND KOUSIN_DATE_HK = " & SQ(strSyoriDate))
