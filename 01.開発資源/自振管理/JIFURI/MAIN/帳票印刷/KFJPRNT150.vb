...
#Region " クラス変数宣言"
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFJPRNT150", "取引先マスタ項目確認票印刷画面")
    Private Const msgTitle As String = "取引先マスタ項目確認票印刷画面(KFJPRNT150)"
...
#Region "ロード"
    ...
    '　なし
    '=======================================================================
    Private Sub KFJPRNT150_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region " ボタン"
    ...
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        ...
        Try
            ...
            Dim iRetValue As Integer = ExeRepo.ExecReport("KFJP062", strParam)
