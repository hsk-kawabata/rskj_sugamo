...
Public Class KFJMAST061
    ...
    Private Const ThisModuleName As String = "KFJMAST061.vb"
    ...
    Private MainLOG As New CASTCommon.BatchLOG("KFJMAST061", "スケジュール管理画面")
    Private Const msgTitle As String = "スケジュール管理画面(KFJMAST061)"
    ...
    '画面起動イベント処理
    Private Sub KFJMAST061_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            With ListView1
                ...
                .Columns.Add("持込SEQ", 0, HorizontalAlignment.Right)              '13
                ...
                .Columns.Add("", 0, HorizontalAlignment.Right)            '25
                .Columns.Add("", 0, HorizontalAlignment.Right)            '26
                .Columns.Add("受付日時", 140, HorizontalAlignment.Center)              '27
    ...
    '画面表示(再表示)イベント処理
    Private Sub KFJMAST061_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        GCom.GLog.Job1 = ThisFormName
    End Sub

    '画面終了時処理
    Private Sub KFJMAST061_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        Try
        ...
        Try
            ...
            If GCom.SetDynaset(sql.ToString, REC) Then
                ...
                Do While REC.Read
                    ...
                    '2017/02/28 タスク）西野 CHG 飯田信金 カスタマイズ対応(受付時間表示対応) -------------------- START
                    Dim Data(27) As String
                    'Dim Data(26) As String
                    '2017/02/28 タスク）西野 CHG 飯田信金 カスタマイズ対応(受付時間表示対応) -------------------- END
                    ...
                    With GCom.NzDec(REC.Item("UKETUKE_TIME_STAMP_S"), "")
                        Data(27) = String.Format("{0}/{1}/{2} {3}:{4}:{5}", .Substring(0, 4), .Substring(4, 2), .Substring(6, 2), .Substring(8, 2), .Substring(10, 2), .Substring(12, 2))
                    End With
                    '2017/02/28 タスク）西野 ADD 飯田信金 カスタマイズ対応(受付タイムスタンプ表示対応) -------------------- END
    ...
    Private Sub CmdKekkaRePrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdKekkaRePrint.Click
        ...
        Try
            ...
            If GCom.NzStr(GCom.SelectedItem(ListView1, 8)) <> "○" Then
                MSG = MSG0087I
                Call MessageBox.Show(MSG, msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Return
            End If
