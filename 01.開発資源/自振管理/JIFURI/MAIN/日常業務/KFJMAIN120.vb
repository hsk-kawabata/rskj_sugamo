...
Public Class KFJMAIN120

#Region "クラス定数"
    Private Const msgTitle As String = "送付状入力処理選択画面(KFJMAIN120)"
...
#Region "クラス変数"
    Private MainLOG As New CASTCommon.BatchLOG("KFJMAIN120", "送付状入力処理選択画面")
...
#Region "イベントハンドラ"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub KFJMAIN120_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '--------------------------------------------------
            'ログの書込に必要な情報の取得
            '--------------------------------------------------
    ...
    Private Sub btnAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAction.Click
        Try
            ...
            ElseIf Me.rbUpd.Checked Then
                '変更
                Dim KFJMAIN122 As New KFJMAIN122
                KFJMAIN122.SELECT_DATE = Me.txtNyuryokuDateY.Text & Me.txtNyuryokuDateM.Text & Me.txtNyuryokuDateD.Text
                CASTCommon.ShowFORM(GCom.GetUserID, CType(KFJMAIN122, Form), Me)
            End If
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub SyoriKbn_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbNew.CheckedChanged, rbUpd.CheckedChanged
        Try
            If Me.rbNew.Checked Then
