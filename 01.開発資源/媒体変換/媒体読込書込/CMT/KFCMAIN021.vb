...
#Region " 定数/変数 "
    ...
    ' LOG関連項目
    '--------------------------------
    Private MainLOG As New CASTCommon.BatchLOG("KFCMAIN021", "媒体書込（ディスク→媒体）画面")
    Private Const msgTitle As String = "媒体書込（ディスク→媒体）画面(KFCMAIN021)"
...
#Region " ロード "
    ...
    Private Sub KFCMAIN021_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                ...
                Case "01"
                    ...
                    If IsNumeric(ToriInfo.FMT_KBN) = True Then
                        ...
                        Else
                            ...
                            Dim WK_LENGTH As Integer = 0
                            Select Case ToriInfo.CODE_KBN
                                Case "2", "3" : WK_LENGTH = 120     '中間ファイルが120バイトのため
                                Case Else : WK_LENGTH = ToriInfo.RECORD_LENGTH
                            End Select
                            If BaitaiWrite_DataCheck(WORK_FILENAME, WK_LENGTH) = False Then
