...
' 自振読込画面
Public Class KFCCMT011
    Inherits System.Windows.Forms.Form

    'CMT読込済フラグ(画面起動後、CMTを読んだかどうかのフラグ)
    Dim ReadCmtFlag As Boolean = False
    ...
    ' CmtReadDataのインスタンス保持用
    Protected cmtReadData(MAXSTACKER) As clsCmtData
...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(KFCCMT011))
        ...
        Me.CmdBack.Location = New System.Drawing.Point(665, 523)
        ...
        Me.lblDate.Location = New System.Drawing.Point(702, 29)
        ...
        Me.lblUser.Location = New System.Drawing.Point(702, 9)
        ...
        Me.LblUserIDCaption.Location = New System.Drawing.Point(638, 9)
        ...
        'CmdRead
        '
        Me.CmdRead.Font = New System.Drawing.Font("ＭＳ ゴシック", 10.0!)
        Me.CmdRead.Location = New System.Drawing.Point(539, 523)
        Me.CmdRead.Name = "CmdRead"
        Me.CmdRead.Size = New System.Drawing.Size(120, 40)
        Me.CmdRead.TabIndex = 1
        Me.CmdRead.Text = "ＣＭＴ読込開始"
        '
        'PrintButton
        '
        Me.PrintButton.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.PrintButton.Location = New System.Drawing.Point(16, 523)
        ...
        Me.ListView1.Location = New System.Drawing.Point(16, 78)
        ...
        'WriteCounter
        '
        Me.WriteCounter.Text = "読込回数"
        Me.WriteCounter.Width = 0
        '
        'ItakuCD
        '
        ...
        Me.FuriDate.Width = 73
        '
        'ItakuKana
        '
        Me.ItakuKana.Text = "委託者カナ"
        Me.ItakuKana.Width = 110
        '
        'ItakuKanji
        '
        Me.ItakuKanji.Text = "委託者漢字"
        Me.ItakuKanji.Width = 0
        '
        'SyoriKen
        '
        Me.SyoriKen.Text = "件数"
        Me.SyoriKen.Width = 58
        '
        'SyoriKin
        '
        Me.SyoriKin.Text = "金額"
        Me.SyoriKin.Width = 100
        '
        'TRTotalKen
        '
        ...
        Me.ToriSCode.Width = 100
        '
        'ToriFCode
        '
        Me.ToriFCode.Text = "副コード"
        Me.ToriFCode.Width = 80
        '
        'StationNo
        '
        Me.StationNo.Text = "機番"
        ...
        Me.ComboFormat.Items.AddRange(New Object() {"全銀/SSS", "地公体(350)", "地公体(300)", "国税", "センター直接持込(請求分)", "センター直接持込(結果分)", "NHK", "総合振込"})
        Me.ComboFormat.Location = New System.Drawing.Point(112, 52)
        Me.ComboFormat.Name = "ComboFormat"
        Me.ComboFormat.Size = New System.Drawing.Size(132, 20)
        Me.ComboFormat.TabIndex = 48
...
#End Region
    ...
    Private Const ThisModuleName As String = "KFCCMT011.vb"
    Protected Const strPrtTitle As String = "ＣＭＴ読込結果"

    '画面起動時処理
    Private Sub KFCCMT011_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        GCom.GLog.Job1 = "CMT読込画面"
    ...
    '画面表示（再表示）時処理
    Private Sub KFJCMT0011G_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        GCom.GLog.Job1 = "CMT読込画面"
    End Sub

    '画面終了時処理
    Private Sub KFJCMT0011G_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub CmdRead_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdRead.Click
        GCom.GLog.Job2 = "読込ボタン"
        Me.CmdRead.Enabled = False
        Me.CmdBack.Enabled = False
        Me.PrintButton.Enabled = False
        CmtCom.CmtReader(Me.ComboFormat.SelectedIndex, False, ListView1, MAXSTACKER)
    ...
    Private Sub CmdBack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdBack.Click
        ' cmtReadDataインスタンスの削除
        Me.Close()
        Me.Dispose()
    End Sub

    '検証用CSV出力&表示
    Private Sub LetMonitor_ListView(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Call GCom.MonitorCsvFile(ListView1)
    End Sub
    ...
    Private Sub ListView1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Text = ListView1.FocusedItem.Text & ":" & ListView1.FocusedItem.SubItems(1).Text & ":" & _
            ListView1.FocusedItem.SubItems(2).Text & _
            ListView1.FocusedItem.SubItems(3).Text & _
            ListView1.FocusedItem.SubItems(4).Text & _
            ListView1.FocusedItem.SubItems(5).Text & _
            ListView1.FocusedItem.SubItems(6).Text & _
            ListView1.FocusedItem.SubItems(7).Text & _
            ListView1.FocusedItem.SubItems(8).Text & _
            ListView1.FocusedItem.SubItems(9).Text & _
            ListView1.FocusedItem.SubItems(10).Text & _
            ListView1.FocusedItem.SubItems(11).Text & _
            ListView1.FocusedItem.SubItems(12).Text & _
            ListView1.FocusedItem.SubItems(13).Text & _
            ListView1.FocusedItem.SubItems(14).Text & _
            ListView1.FocusedItem.SubItems(15).Text & _
            ListView1.FocusedItem.SubItems(16).Text & _
            ListView1.FocusedItem.SubItems(17).Text & _
            ListView1.FocusedItem.SubItems(18).Text & _
            ListView1.FocusedItem.SubItems(19).Text & _
            ListView1.FocusedItem.SubItems(20).Text & _
            ListView1.FocusedItem.SubItems(21).Text
    End Sub
    ...
    Private Sub PrintButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintButton.Click
        ...
        Me.CmdBack.Enabled = False
        Me.PrintButton.Enabled = False
        Call CmtCom.PrintButton(ListView1, strPrtTitle) ' 印刷ボタン処理
        Me.CmdRead.Enabled = True
        Me.CmdBack.Enabled = True
        Me.PrintButton.Enabled = True
    End Sub
