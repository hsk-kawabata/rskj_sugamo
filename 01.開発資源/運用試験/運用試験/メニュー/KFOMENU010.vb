...
Public Class KFOMENU010

#Region " 変数宣言 "
    Private noClose As Boolean
    Private MyOwnerForm As Form

    Private MainLOG As New CASTCommon.BatchLOG("KFOMENU010", "運用試験メニュー")
    Private Const msgTitle As String = "運用試験メニュー(KFOMENU010)"
...
#Region " ロード "
    ...
    Private Sub KFOMENU010_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region " クローズ "
    ...
    Private Sub KFOMENU010_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
